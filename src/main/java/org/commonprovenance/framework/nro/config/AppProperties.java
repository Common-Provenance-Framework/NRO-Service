...
public class AppProperties {
  ...
  public String getTrustedCertsDirPath() {
    return trustedCertsDirPath;
  }
  public void setTrustedCertsDirPath(String trustedCertsDirPath) {
    this.trustedCertsDirPath = trustedCertsDirPath;
  }
