...
public class OrganizationIdMismatchException extends RuntimeException {
  ...
  public OrganizationIdMismatchException(String message) {
    super(message);
  }
  public OrganizationIdMismatchException(String message, Throwable cause) {
    super(message, cause);
  }
  public OrganizationIdMismatchException(Throwable cause) {
    super(cause);
  }
